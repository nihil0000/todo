...
<div class="category__content">
    <form class="create-form" action="/categories" method="post">
        ...
        <div class="create-form__item">
            <input class="create-form__item-input" type="text" name="category_name" value="{{ old('name') }}">
        </div>
                ...
                <td class="category-table__item">
                    <form class="update-form" action="/categories/update" method="post">
                        ...
                        <div class="update-form__item">
                            <input class="update-form__item-input" type="text" name="category_name" value="{{ $category['category_name'] }}">
